...
/** GET /api/affiliate — returns the user's referral code, stats, and recent referrals */
export async function GET() {
  ...
  if (subscription?.plan !== "annual_unlimited") {
    return NextResponse.json({ error: "Affiliate program requires a Maker Pro subscription." }, { status: 403 });
  }
