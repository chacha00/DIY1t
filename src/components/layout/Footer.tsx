...
const SOCIALS = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61591374851163",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/diy1t",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
            ...
            <div className="mt-5 flex gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-100 text-slate-500 transition hover:bg-brand-blue-100 hover:text-brand-blue-600"
                >
                  {s.icon}
                </a>
              ))}
