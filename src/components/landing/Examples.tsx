...
const EXAMPLES = [
  ...
  },
  {
    ...
    materials: ["Fleece fabric ½ yd", "Ribbed knit cuff fabric ¼ yd", "Velcro closure strip 6\"", "Thread + elastic ¼\""],
    time: "2 hrs",
    cost: "$12",
    retail: "$42",
    savings: "71%",
    pieces: [
      { label: "BODY PANEL", sub: "Cut 2", dim: "14\" × 10\"", x: 5, y: 5, w: 100, h: 55 },
      { label: "NECK BAND", sub: "Cut 1", dim: "12\" × 3\"", x: 118, y: 5, w: 97, h: 28 },
      { label: "LEG OPENING", sub: "Cut 2", dim: "6\" × 2\"", x: 118, y: 43, w: 97, h: 27 },
    ],
  },
];
